...
echo -e "${BLUE}=============================================${NC}"
echo ""
echo -e "Target: ${GREEN}https://signinsoft1.gsgroups.net${NC}"
echo -e "cPanel: ${GREEN}https://gsgroups.net:2083${NC}"
echo ""
...
if CPANEL_PASSWORD="$CPANEL_PASSWORD" node cpanel-deploy.js; then
    ...
    echo -e "${GREEN}🌐 Your application is live at: https://signinsoft1.gsgroups.net${NC}"
    exit 0
fi
...
echo "   - Enable Let's Encrypt for signinsoft1.gsgroups.net"
echo ""
echo -e "${GREEN}After completing these steps, your application will be live!${NC}"
echo ""
echo -e "${BLUE}Test URLs:${NC}"
echo "• https://signinsoft1.gsgroups.net/"
echo "• https://signinsoft1.gsgroups.net/api/health"
echo "• https://signinsoft1.gsgroups.net/api/auth/register"
echo ""
